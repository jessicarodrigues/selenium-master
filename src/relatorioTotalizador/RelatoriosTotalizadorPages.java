...
public class RelatoriosTotalizadorPages {
	...
	public RelatoriosTotalizadorPages(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void visita() {
		...
		try {
			...
			print(propScreenshotLogin.getProperty(PropKeys.PROP_PRINT_SCREEN_REL_TOTALIZADOR_LOGIN_1));
	...
	public NovoRelatoriosTotalizadorPage novo() {
		...
		try {
			...
			print(propScreenshotMenu.getProperty(PropKeys.PROP_PRINT_SCREEN_REL_TOTALIZADOR_MENU_2));
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@id=\"menu_mobile\"]/ul[1]/li[7]/ul/li[1]/a")).click();
			Thread.sleep(1000);
			print(propScreenshotMenu.getProperty(PropKeys.PROP_PRINT_SCREEN_REL_TOTALIZADOR_TELA_REL_3));
			Thread.sleep(1000);
		...
		return new NovoRelatoriosTotalizadorPage(driver);
	}

...
public class RelatorioTransacoesRejeitadasPages {
	...
	public RelatorioTransacoesRejeitadasPages(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void visita() {
		...
		try {
			...
			print(propScreenshotLogin.getProperty(PropKeys.PROP_PRINT_SCREEN_REL_TRANSACOES_REJEITADA_LOGIN_1));
	...
	public NovoRelatorioTransacaoRejeitadaPage novo() {
		try {
			...
			print(propScreenshotMenu.getProperty(PropKeys.PROP_PRINT_SCREEN_REL_TRANSACOES_REJEITADA_MENU_2));
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@id=\"menu_mobile\"]/ul[1]/li[7]/ul/li[5]/a")).click();
			print(propScreenshotMenu.getProperty(PropKeys.PROP_PRINT_SCREEN_REL_TRANSACOES_REJEITADA_TELA_REL_3));
			Thread.sleep(1000);
		...
		return new NovoRelatorioTransacaoRejeitadaPage(driver);

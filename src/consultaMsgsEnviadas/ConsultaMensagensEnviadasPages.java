...
public class ConsultaMensagensEnviadasPages {
	...
	public ConsultaMensagensEnviadasPages(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void visita() {
		...
		try {
			...
			print(propScreenshotLogin.getProperty(PropKeys.PROP_PRINT_SCREEN_MSGS_ENVIADAS_LOGIN_1));
	...
	public NovoConsultaMsgsEnviadasPage novo() {
		...
		try {
			...
			print(propScreenshotMenu.getProperty(PropKeys.PROP_PRINT_SCREEN_MSGS_ENVIADAS_MENU_2));
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@id=\"menu_mobile\"]/ul[1]/li[6]/ul/li[1]/a")).click();
			Thread.sleep(1000);
			print(propScreenshotMenu.getProperty(PropKeys.PROP_PRINT_SCREEN_MSGS_ENVIADAS_TELAMSGS_ENV_3));

		} catch (Exception e) {
			e.printStackTrace();
		}

		return new NovoConsultaMsgsEnviadasPage(driver);
	}

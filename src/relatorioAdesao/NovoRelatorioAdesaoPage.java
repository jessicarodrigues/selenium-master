...
public class NovoRelatorioAdesaoPage {
	
	private final WebDriver driver;
	ArquivoPropertie propriedade = new ArquivoPropertie();

	public NovoRelatorioAdesaoPage(WebDriver driver) {
		this.driver = driver;
	}
	
	public void preenche(String tipoRelatorio, String tipoServico, String categorizacao, String canal, 
			String dtInicio, String dtFinal, String superintendencia, String agencia){
		
		try {
			
			JavascriptExecutor js = (JavascriptExecutor) driver;
			Select cbRelatorio = new Select(driver.findElement(By.name("tipoRelatorio")));
			cbRelatorio.selectByValue(tipoRelatorio);
			Thread.sleep(2000);
			Select cbServico = new Select(driver.findElement(By.name("tipoServico")));
			cbServico.selectByValue(tipoServico);
			Thread.sleep(2000);
			...
			Select cbSuperintendencia = new Select(driver.findElement(By.name("superintendenciaSel")));
			cbSuperintendencia.selectByVisibleText(superintendencia);
			Thread.sleep(2000);
			...
			printTela(propScreenshot.getProperty(PropKeys.PROP_PRINT_SCREEN_ADESAO_PREENCHE_CAMPOS_4));
			Thread.sleep(2000);
	...
	public void printTela(String nome){
		new RelatorioAdesaoPages(driver).print(nome);
	}
}

...
public class ParametrosPagesAltera {
	...
	public ParametrosPagesAltera(WebDriver driver){
		this.driver = driver;
	}
...
public static Properties getProp() throws Exception{
	...
	public NovoParametroPageAltera novo(){
		...
		driver.findElement(By.xpath("//*[@id=\"menu_mobile\"]/ul[1]/li[5]/a")).click();
		driver.findElement(By.xpath("//*[@id=\"menu_mobile\"]/ul[1]/li[5]/ul/li/a")).click();
		
		return new NovoParametroPageAltera(driver);

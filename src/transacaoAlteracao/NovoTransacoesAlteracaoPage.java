...
public class NovoTransacoesAlteracaoPage {

	private final WebDriver driver;
	ArquivoPropertie propriedade = new ArquivoPropertie();

	public NovoTransacoesAlteracaoPage(WebDriver driver) {
		this.driver = driver;
	}
	
	
	public void consultaAlteracaoTransacao(String categoria, String servicos){
		...
		try {
			...
			printTela(propScreenshot.getProperty(PropKeys.PROP_PRINT_SCREEN_TRANSACAO_ALTERACAO_PREENCHE_CAMPOS_4));
	...
	public void printTela(String nome){
		new ConsultaTransacoesAlteracaoPages(driver).print(nome);
	}
